...
namespace Kinesis::Mesh {
	class Vertex {
		public:
			...
			Vertex(int i, const Kinesis::Math::Vector3 &pos) : position(pos) { index = i; s = 0; t = 0; }

			// =========
			// ACCESSORS
			int getIndex() const { return index; }
			const Kinesis::Math::Vector3& getPos() const { return position; }
